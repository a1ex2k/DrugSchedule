...
{
    public partial interface IDrugScheduleApi
    {
        [Post("/api/Auth/Login")]
        ...
        [Post("/api/Contacts/GetAll")]
        Task GetAll();

        [Post("/api/Contacts/GetCommon")]
        Task GetCommon();

        [Post("/api/Contacts/GetSingleExtended")]
        Task GetSingleExtended([Body] UserIdDto body);

        [Post("/api/Contacts/GetManyExtended")]
        Task GetManyExtended([Body] UserContactFilterDto body);

        [Post("/api/Contacts/AddOrUpdate")]
