...
internal static class EndpointsPaths
{
    ...
    public const string Contacts_GetAll = "/api/Contacts/GetAll";
    public const string Contacts_GetCommon = "/api/Contacts/GetCommon";
    public const string Contacts_GetSingleExtended = "/api/Contacts/GetSingleExtended";
    public const string Contacts_GetManyExtended = "/api/Contacts/GetManyExtended";
    public const string Contacts_AddOrUpdate = "/api/Contacts/AddOrUpdate";
    public const string Contacts_Remove = "/api/Contacts/Remove";
